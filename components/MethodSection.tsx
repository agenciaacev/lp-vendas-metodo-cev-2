    ...
    <section className="py-28 relative" style={{background: 'var(--bg-secondary)'}}>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <h2 className="font-bebas" style={{fontSize: 'clamp(2.11rem, 4.22vw, 4.22rem)', color: 'var(--text-primary)', lineHeight: '1.15'}}>
            Conheça o <span className="gold-gradient">MÉTODO CEV</span><br />
            em Detalhes
          </h2>
        ...
        <div className="relative max-w-4xl mx-auto mb-10 sm:mb-20 sm:pb-12" data-aos="fade-up" data-aos-duration="800">
          ...
          {/* Book overlaid bottom-right — desktop only */}
          <div className="hidden sm:block absolute -bottom-6 -right-4 z-10"
