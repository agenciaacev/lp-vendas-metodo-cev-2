      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div data-aos="fade-left" data-aos-duration="900" data-aos-delay="150">
            <p className="section-label mb-4">SOBRE A MENTORA</p>
            <h2 className="font-bebas mb-6 leading-none" style={{fontSize: 'clamp(2.46rem, 6.34vw, 6.34rem)'}}>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {['@cleanefontenele', '@cleanementora'].map((handle) => (
                <div key={handle} className="flex items-center gap-2 px-4 py-2 rounded-sm text-sm"
            ...
            <div className="mt-6 pt-6 flex flex-wrap gap-2" style={{borderTop: '1px solid var(--border)'}}>
              {['Agência ACEV', 'Programa Corpo e Estilo de Vida', 'Clube CleanFit'].map((role) => (
                <span key={role} className="px-3 py-1 text-xs rounded-sm"
